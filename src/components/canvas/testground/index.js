...
import Stats from '../../threejs/lib/stats.js'
// https://codepen.io/ycw/pen/VBBrBd
...
//     this._gradient = this.createRadialGradient(...gradient.points) // [x1, y1, r1, x2, y2, r2......]
//     for (let color of gradient.color) this._gradient.addColorStop(color)
//   }
//   draw() {
