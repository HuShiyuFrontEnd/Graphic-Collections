...
// https://codepen.io/al-ro/pen/qrNRVE
...
DI.insertDOM(`
    ...
    <div class="instructions">CLICK AND DRAG LIGHT SOURCES AROUND</div>
`).addCSSStyle(`
    body {
...
for(var s = 0; s < seeds.length-1; s++){
  for(var n = s+1; n < seeds.length; n++){
...
function draw() {
  ...
  for (i = 0; i < barriers.length; i++) {
    for (var j = 0; j < barriers[i].point_count; j++) {
      var vertex = {
  ...
  for(var l = 0; l < lights.length; l++){
    ...
    for (var r = 4; r < vertices.length; r++) {
