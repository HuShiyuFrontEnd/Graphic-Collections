console.log("this is main js for piece - amethyst in project threejs");

console.log('%cAmethyst紫水晶', 'color:#C4A4F5;');
...
function setScene() {
  ...
  container.style.background = 'radial-gradient(circle, #fce0ff, #be9ef4 100%)';
