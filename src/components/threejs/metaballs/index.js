console.log("this is main js for piece - metaballs in project threejs")

import '../lib/base';
import './src/CopyShader.js';
import './src/EffectComposer.js';
import './src/LuminosityShader.js';
import './src/ShaderPass';
import './src/RenderPass';

document.getElementById('container').style.display = 'none';
document.body.style.background = 'radial-gradient(at 50% 50%, rgba(67, 148, 123, 0.2), rgba(67, 148, 123, 0.8))';
...
let canvas = simulation.renderer.domElement;
