...
GL.preload(assestList, (textures) => {
    ...
    //设置纹理的X/Y轴方向延展规则（如果不足的话） S/T对应X/Y
...
//一般情况下，顶点着色器中含有0个以上纹理单元（99%以上的机器至少含有4个），片元着色器中含有至少8个纹理单元。可以使用以下方法查看当前环境下的纹理单元数量
console.log(gl.getParameter(gl.MAX_TEXTURE_IMAGE_UNITS), '片元着色器纹理单元数');
console.log(gl.getParameter(gl.MAX_VERTEX_TEXTURE_IMAGE_UNITS), '顶点着色器纹理单元数')
