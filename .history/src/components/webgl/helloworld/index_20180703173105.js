...
//准备着色器
let vertex_shader = GL.createShader(gl.VERTEX_SHADER, vertex);
let fragement_shader = GL.createShader(gl.FRAGMENT_SHADER, fragment);
let program = GL.linkShader(vertex_shader, fragement_shader);
console.log(vertex_shader, fragement_shader)
