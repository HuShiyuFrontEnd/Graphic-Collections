...
import geometry from '@/components/webgl/lib/geometry/js';
import vertex from './vertex.html';
import fragment from './fragment.html';
//着色器，将我们提供的数据按照着色器内的方法转化后存进GPU中
...
let uniform_resolution = gl.getUniformLocation(program,'u_resolution');
gl.uniform2f(uniform_resolution, gl.canvas.width, gl.canvas.height);
...
var count = positions.length / size;//着色器运行次数，
